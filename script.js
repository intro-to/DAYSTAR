...
form.addEventListener("submit", function (event) {
  ...
  ageError.textContent = "age is needed";
  locationError.textContent = "should be in kampala ";
  dobError.textContent = "should be below 4 years";
  genderError.textContent = "fill in sex ";
